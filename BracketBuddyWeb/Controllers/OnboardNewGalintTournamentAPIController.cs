...
namespace BracketBuddyWeb.Controllers
{
    public class OnboardNewGalintTournamentAPIController : Controller
    {
        ...
        public async Task<ActionResult> Index(string id, string bannerOverride, string twitter)
        {
            ...
            var existingCurrentTournaments = await BracketBuddyDatabase.Instance.GetCurrentTournamentsAsync();
            ...
            await BracketBuddyDatabase.Instance.AddCurrentTournamentAndSetAsActiveAsync(tournament);
